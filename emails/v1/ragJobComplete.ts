...
export function ragJobComplete_SES_Config(
  email: string,
  RESULTS_LINK: string,
  language: any
) {
  ...
  console.log("Rag Request Complete email");
  ...
  return {
    ...
    { 
      \"SUBJECT\":\"${
        translations.ragJobComplete.subject
        // true
        // req.t("emails:summaryJobComplete.subject")
      }\", 
      \"MESSAGE_AS_TEXT\":\"${
        translations.ragJobComplete["message-as-text"]
        // true
        // req.t("emails:summaryJobComplete.message-as-text")
      }\",
      \"GREETING\":\"${
        translations.ragJobComplete.greeting
        // true
        // req.t("emails:summaryJobComplete.greeting")
      }\",
      \"MESSAGE\":\"${
        `${translations.ragJobComplete.message} ${RESULTS_LINK}`
        // true
